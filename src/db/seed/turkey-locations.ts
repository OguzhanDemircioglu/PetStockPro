export const TURKEY_DISTRICTS: Record<string, string[]> = {
  ...
  'Burdur': ['Ağlasun','Altınyayla','Bucak','Çavdır','Çeltikçi','Gölhisar','Karamanlı','Kemer','Merkez','Söğüt','Tefenni','Yeşilova'],
  ...
  'Erzurum': ['Aşkale','Aziziye','Çat','Hınıs','Horasan','İspir','Karaçoban','Karayazı','Köprüköy','Merkez','Narman','Oltu','Olur','Palandöken','Pazaryolu','Şenkaya','Tekman','Tortum','Uzundere','Yakutiye'],
  ...
  'Kars': ['Akyaka','Arpaçay','Digor','Göle','Kağızman','Merkez','Sarıkamış','Selim','Susuz'],
  ...
  'Manisa': ['Ahmetli','Akhisar','Alaşehir','Demirci','Gölmarmara','Gördes','Kırkağaç','Köprübaşı','Kula','Merkez','Salihli','Sarıgöl','Saruhanlı','Selendi','Soma','Şehzadeler','Turgutlu'],
