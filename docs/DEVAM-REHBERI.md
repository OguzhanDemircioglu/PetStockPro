...
**Mevcut Branch:** `cray61` — origin'in **74 commit** ileri (push edilmedi)
**Son commit:** (pending) feat(sitemap): cache-first /sitemap.xml/route.ts handler + globalThis singleton
