...
**Mevcut Branch:** `cray61` — origin'in **79 commit** ileri (push edilmedi)
**Son commit:** (pending) feat(error): custom global error boundary (TR + marka + digest gösterimi)
