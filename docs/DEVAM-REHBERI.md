...
**Mevcut Branch:** `cray61` — origin'in **72 commit** ileri (push edilmedi)
**Son commit:** (pending) feat(sitemap): pre-build foundation — R2 cache + cron rebuild endpoint
**Test:** 1100 passed (79 dosya) — vitest
